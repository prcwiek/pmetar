...
With  the default value of the paremeter *metric= TRUE* and *numeric_only = FALSE* we get output in meters.
...
```
When the visibilty is described as for example P6SM we can decode in two ways
