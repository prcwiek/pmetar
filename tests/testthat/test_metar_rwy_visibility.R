...
test_that("Check runway visibility in meters", {
  ...
  expect_equal(is.na(metar_rwy_visibility(x3, metric = TRUE)), TRUE)
...
test_that("Check runway visibility in feet", {
  ...
  expect_equal(is.na(metar_rwy_visibility(x3, metric = FALSE)), TRUE)
...
test_that("Incorrect METAR reports", {
  expect_equal(is.na(metar_rwy_visibility(x6)), TRUE)
  expect_equal(is.na(metar_rwy_visibility(x7)), TRUE)
  expect_equal(is.na(metar_rwy_visibility(x8)), TRUE)
})
