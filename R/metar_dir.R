...
#' @param numeric_values_only logical; if TRUE only a numeric value of direction will be returned
#'
...
#' metar_dir("CYUL 281800Z 13008KT 30SM BKN240 01/M06 A3005 RMK CI5 SLP180", numeric_values_only = TRUE)
#' metar_dir("201711271930 METAR LEMD 271930Z 02002KT CAVOK 04/M03 Q1025 NOSIG= NOSIG=")
#'
metar_dir <- function(x, numeric_values_only = FALSE){
