...
#' metar_decode("202509251120 SPECI CYUL 251120Z 06007KT 6SM RA BKN015 OVC065 16/15 A2995 RMK SC5SC3")
#' 
    ...
    expr = {
      ...
      outx <- outx %>%
        dplyr::mutate(Remark = "Don't use for flight planning or navigation!",
                      ...
                      Pressure_unit = ifelse(!altimeter, "hPa", "mmHg"),
                      Visibility = metar_visibility(outx$Original_METAR, metric = metric, numeric_only = numeric_only),
                      Visibility_unit = ifelse(metric, "m", "mile"),
